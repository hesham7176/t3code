...
class NotConfiguredCloudProvider(override val id: String, override val name: String) : CloudProvider {
    ...
    override suspend fun list(parentId: String?): Result<List<CloudEntry>> = unsupported()
    override suspend fun download(id: String): Result<InputStream> = unsupported()
    override suspend fun upload(parentId: String?, name: String, source: InputStream): Result<CloudEntry> = unsupported()
